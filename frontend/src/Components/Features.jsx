      ...
      <div className="flex flex-col md:flex-row items-center gap-4 md:gap-24 max-w-7xl mx-auto">
        <div className="flex-1 space-y-6 md:space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">
            {text1}
            <span className="block text-slate-100">{text2}</span>
          </h1>
          ...
          <div className="relative">
            <p className="text-slate-200 leading-relaxed">{text4}</p>
            <div className="absolute -left-4 top-0 bottom-0 w-1 bg-slate-500"></div>
          </div>
        </div>

        <div className="flex-1 relative">
          <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500 to-purple-500 rounded-2xl transform rotate-3 scale-105 opacity-10"></div>
          <img
            src={image}
