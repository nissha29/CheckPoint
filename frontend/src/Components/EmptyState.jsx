...
export function EmptyState({ setIsCreateNewTaskOpen }){
    return <div className="text-center py-12">
      <div className="bg-slate-800 rounded-xl p-8 max-w-md mx-auto">
        ...
        <button 
          ...
          className="px-4 py-2 bg-blue-600 rounded-lg flex items-center justify-center gap-2 hover:bg-blue-700 mx-auto"
        >
          <Plus size={20} />
