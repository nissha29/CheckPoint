...
const LandingPage = () => {
  const suggestions = [
    ...
    {
      text: "Set priorities for today",
      icon: <Clock className="w-6 h-6 text-green-500" />,
    },
    {
      text: "Delegate tasks to team",
      icon: <Users className="w-6 h-6 text-purple-500" />,
    },
    {
      text: "Track project deadlines",
  ...
  const cards = [
    {
      ...
      text: "Navigate your tasks with ease. Our clean, user-friendly design ensures you spend less time managing your to-do list and more time conquering it.",
    },
    {
      heading: "Smart Prioritization",
      text: "Let CheckPoint's AI-powered system help you focus on what truly matters. It learns your habits and suggests the most impactful tasks to tackle first.",
    },
    {
      heading: "Seamless Integration",
      text: "Connect CheckPoint with your favorite tools. From calendar apps to project management software, we play well with others to keep your workflow smooth.",
    },
    {
      heading: "Collaborative Power",
      text: "Share tasks, delegate responsibilities, and track progress across teams. CheckPoint makes collaboration a breeze, whether you're working remotely or in the office.",
    },
    {
      heading: "Customizable Workflows",
      text: "Tailor CheckPoint to fit your unique needs. Create custom tags, set up recurring tasks, and design workflows that match your personal or professional style.",
    },
    {
      heading: "Progress Insights",
      text: "Visualize your productivity with beautiful, easy-to-understand charts and reports. Celebrate your wins and identify areas for improvement.",
    },
    {
      heading: "Mobile Accessibility",
      text: "Take CheckPoint wherever you go. Our mobile app ensures you're always connected to your tasks, whether you're at your desk or on the move.",
    },
    {
      heading: "Automated Reminders",
      text: "Never miss a deadline with intelligent notification systems. Set up customizable alerts and let CheckPoint keep you on track with gentle, timely reminders for your important tasks.",
    },
  ];
